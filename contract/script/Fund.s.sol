...
contract Fund is Script {
    ...
    function run() external {
        ...
        // Mint some mock USDC to the script itself
        uint256 mintAmount = 1_000_000 * 1e6; // 1,000,000 USDC
        assetToken.mint(address(this), mintAmount);
        console.log("Minted", mintAmount, "mock USDC to script");

        vm.stopBroadcast();

        // Start a new broadcast and prank as the script contract
